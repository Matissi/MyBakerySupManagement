 ...
 /*   if(isset($_GET['delete'])){
      ...
      $del = "DELETE * from users where user_id=".$_GET['id'];
          ...
          if(mysqli_query($conn,$del))
          {
              ...
              <?php header("Location: users_information.php"); ?>
              <?php 
            }
            else
            {
                    ...
                    <table class="table">
                      ...
                      <tbody>
                        <?php 
                          ...
                          while ($userRow=mysqli_fetch_array($ress,MYSQLI_ASSOC))
                          {
                              $users[] = $userRow;
                          }
                        ...
                        <tr>
                          <td><?php echo $userRow['profile']; ?></td>
                          <td><?php echo $userRow['email']; ?></td>
                          <td><?php echo $userRow['name']; ?></td>
                          <?php 
                          /*
                        <input type="hidden" name="id" value="<?php echo $userRow['s_id']; ?>"/>
